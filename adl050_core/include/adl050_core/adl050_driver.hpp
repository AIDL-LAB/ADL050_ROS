// _ip50_DRIVER_HPP_
#ifndef _adl050_DRIVER_HPP_
#define _adl050_DRIVER_HPP_
...
#include <adl050_msgs/RobotMotor.h>
...
namespace aidl
{
	...
	public:
		// constructor
		adl050BodyNode(ros::NodeHandle *nh) : x_(0), y_(0), th_(0), delta_x_(0), delta_y_(0), delta_th_(0), vx_(0), vy_(0), vth_(0),
		...
		void rpm_vel_callback(const adl050_msgs::RobotMotor &msg)
		{
		...
		{
			// [m/s]
			adl050_msgs::RobotMotor motor_msg;
